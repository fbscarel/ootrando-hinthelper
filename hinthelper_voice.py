...
def askq(olist, qt, ct):
    ...
    while True:
        ...
        try:
            c = rec.recognize_google(audio).lower()
...
def main_prompt():
    ...
    op = {"song": song_hint,
          ...
          "clear": kill_hint,
          "shop": shop_sanity,
          "entrance": entrance_sanity,
          "cow": cow_sanity,
          "scrub": scrub_sanity,
          "advanced": advanced_tricks,
          "check": woth_edit,
          "exit": pexit}

    print("\n=====================================================================")
    print("\n" + pc("(W)","y") + "oth | " + pc("(N)","y") + "ew Check | " + pc("(F)","r") + "oolish | " + pc("(S)","g") + "ong | " + pc("(I)","c") + "tem | " + pc("(U)","u") + "seless")
    print("\n" + "s" + pc("(H)","m") + "ops | " + pc("(C)","m") + "ows | " + "sc" + pc("(R)","m") + "ubs | " + "en" + pc("(T)","m") + "rances")
    print("\n" + pc("(A)","w") + "dvanced tricks | " + pc("(U)","w") + "ndo | " + pc("(K)","w") + "lear | " + pc("(E)","w") + "xit ", end="")
    print("\n=====================================================================")
    print("\n" + "Last detected command: " + cmd, end="")
    r = sr.Recognizer()
    with sr.Microphone() as source:
